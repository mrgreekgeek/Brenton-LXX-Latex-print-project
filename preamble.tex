...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[ER,LO]{\leftmark}
\fancyhead[EL,OR]{\rightmark} % the chapter numbers defined in \ch
\fancyfoot[C]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\chaptermark}[1]{\markboth{#1}{}} % Put the name of the chapter in the header
